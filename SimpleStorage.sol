...
contract SimpleStorage
{
    ...
    // view and pure don't spend gas since they are reading from the blockchain
    // and not performing any modifications
    // *~*however, calling a view function from another view function will cost gas
    // view - reads state
